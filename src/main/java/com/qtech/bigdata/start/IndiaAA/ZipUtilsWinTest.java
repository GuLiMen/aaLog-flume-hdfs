...
public class ZipUtilsWinTest {
    ...
    public static List<String> readFile() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("./resources/putListBak")));//构造一个BufferedReader类来读取文件
    ...
    public static void writeMethod() {
        String fileName = "./resources/putListBak";
        try {
    ...
    public static void main(String[] args) throws IOException {
        for (String a :noSavedataPath()) {
            for (File s : getData(a)) {
