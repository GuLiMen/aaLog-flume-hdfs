...
public class SendEMailWarning_bak1 {


    public static boolean sendMail(List<String> recipients, String subject, String content, File attachment,File attachment2) {
